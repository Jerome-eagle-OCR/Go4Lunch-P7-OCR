...
//    public static final String TEST_USER2_PWD = "raimbaud";
    ...
    static {
        TEST_RESTAURANT.setId(TEST_CHOSEN_RESTAURANT_ID);
    ...
    static {
        TEST_RESTAURANT1_VIEWSTATE = new RestaurantViewSate(
                TEST_RESTAURANT.getId(),
                TEST_RESTAURANT_BITMAP,
                TEST_RESTAURANT.getName(),
                "88m",
    ...
    static {
        TEST_RESTAURANT2_VIEWSTATE = new RestaurantViewSate(
                TEST_CHOSEN_RESTAURANT2.getPlaceId(),
                null,
