...
public class RepositoriesConstantsTest {
    ...
    public void placeAutocompleteRepositoryConstants_NoTestRunning_AreOk() {
        Assert.assertEquals(HTTPS_MAPS_GOOGLEAPIS_COM_MAPS_API_PLACE, PlaceAutocompleteRepository.BASE_URL);
    }

    @Test
    public void userRepositoryConstants_NoTestRunning_AreOk() {
        Assert.assertEquals(USERS, UserRepository.USERS_COLLECTION_NAME);
    }

    @Test
    public void restaurantRepositoryConstants_NoTestRunning_AreOk() {
        Assert.assertEquals(RESTAURANTS, RestaurantRepository.RESTAURANTS_COLLECTION_NAME);
        Assert.assertEquals(CHOSEN_RESTAURANTS, RestaurantRepository.CHOSEN_COLLECTION_NAME);
        Assert.assertEquals(LIKED_RESTAURANTS, RestaurantRepository.LIKED_COLLECTION_NAME);
    }
}
