...
public class GetUserViewStatesTest {
    ...
    public void getUserViewStates_NoLoggedUser_NoRestaurantChosenByAnyUser_WithSuccess() {
        underTestGetUserViewStates = new GetUserViewStates(null);
    ...
    @Test
    public void getUserViewStates_OneUserLogged_NoCurrentUserLogged_NoRestaurantChosenByAnyUser_WithSuccess() {
        underTestGetUserViewStates = new GetUserViewStates(null);
        allLoggedUsers.put(TEST_USER2_ID, TEST_USER2);

        // Workmate list case: 1 logged user other than current -> 1 workmate (not decided yet)
        List<UserViewState> actual_userViewstates =
                underTestGetUserViewStates.getUserViewStates(null, allLoggedUsers, userChosenRestaurantMap);
        ...
        // Joining workmate list case: 1 logged user other than current -> 0 workmate as displayed restaurant not chosen
        Assert.assertTrue(underTestGetUserViewStates.getUserViewStates(TEST_CHOSEN_RESTAURANT.getPlaceId(),
                                                                       allLoggedUsers,
                                                                       userChosenRestaurantMap)
                                                                       .isEmpty());
    ...
    public void getUserViewStates_OnlyCurrentUserLogged_NoRestaurantChosenByAnyUser_WithSuccess() {
        underTestGetUserViewStates = new GetUserViewStates(TEST_USER1);
